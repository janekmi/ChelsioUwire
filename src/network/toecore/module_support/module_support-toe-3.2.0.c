 ...
 */
static void (*rt_bind_peer_p)(struct rtable *rt, __be32 daddr, int create);
				  ...
				  int addr_len)
{
	...
	if (tcp_death_row.sysctl_tw_recycle &&
		...
		struct inet_peer *peer = rt_get_peer_offload(rt, fl4->daddr);
		/*

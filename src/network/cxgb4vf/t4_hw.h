...
enum {
	...
	FLASH_FAILOVER_START_SEC = 32,
	FLASH_FAILOVER_NSECS = 31,
	FLASH_FAILOVER_START = FLASH_START(FLASH_FAILOVER_START_SEC),
	FLASH_FAILOVER_MAX_SIZE = FLASH_MAX_SIZE(FLASH_FAILOVER_NSECS),
#endif
};

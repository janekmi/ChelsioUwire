...
struct net_device *bond_3ad_xmit_xor_select(int slave_no, struct net_device *dev)
{
	struct bonding *bond = netdev_priv(dev);
	struct net_device *slave_dev = NULL;
	struct slave *slave;
